 ...
 * @LastEditTime: 2022-11-20 20:35:05
 * @FilePath: \unit_test_encoder\lib\config\base_config.h
 * @Description: 
 * 
...
#define COUNTS_PER_REV1 (378*4)              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 (378*4)              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 (378*4)             // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 (378*4)             // wheel4 encoder's no of ticks per rev
