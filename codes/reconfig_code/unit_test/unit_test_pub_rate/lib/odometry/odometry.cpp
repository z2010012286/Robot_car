 ...
 * @LastEditTime: 2022-11-27 15:32:00
 * @FilePath: \unit_test_pub_rate\lib\odometry\odometry.cpp
 * @Description:
 *
                       ...
                       heading_(0.0)
{
    ...
    odom_msg_.header.frame_id.data = (char *)malloc(10 * sizeof(char));
    char string3[] = "/odom";
    ...
    odom_msg_.header.frame_id.capacity = 10;

    odom_msg_.child_frame_id.data = (char *)malloc(20 * sizeof(char));
    ...
    odom_msg_.child_frame_id.capacity = 20;
